	...
	private static final long serialVersionUID = -4867835391733715828L;
      ...
      protected void paintComponent(Graphics g){
    	...
    	try{
    	 ...
    	 g2.drawString("Резултат : "+Cross.SCORE, 20, 820);
    	 g2.drawString("Трудност : "+(Cross.thread_sleep_param == 3 ?"Лесно" : "Трудно"), 20, 850);
    	 g2.drawString("За инфо (I)", 20, 880);
    	 g2.setColor(Color.RED);
    	 g2.setFont(new Font("Courier New",Font.BOLD,30));
    	 g2.drawString((Obstacles.checkForCloseTrain() ? "ВЛАК" : ""), 400, 840);
    	 if(Cross.isOver){ 
    	 ...
    	 if(Cross.isPaused && !Cross.isOver){
    		 g2.setColor(Color.BLUE);
    		 g2.setFont(new Font("Courier New",Font.BOLD,50));
    		 g2.drawString("ПАУЗА", 10, 50);
    	 }
    	 if(Cross.isDisplayingInfo && !Cross.isOver)
    	 {
    		 g2.setColor(Color.BLUE);
    		 g2.setFont(new Font("Courier New",Font.BOLD,50));
    		 g2.drawString("Контроли ", 50, 475);
    		 g2.drawString("         W", 210, 450);
    		 g2.drawString("        A S D", 187, 500);
    		 g2.drawString("Трудност", 50, 560);
    		 g2.drawString("(2) За лесно ", 300, 550);
    		 g2.drawString("(1) За трудно ", 300, 590);
      ...
      Image carImage_RIGHT(int index){
        ...
        Image busImage_LEFT(int index){
          	 Toolkit tool = Toolkit.getDefaultToolkit();
          	 Image[] images = {
          			tool.getImage(getClass().getResource("Obstacles/Truck_1_Right.png")), 
        ...
        Image busImage_RIGHT(int index){
         	 ...
         	 Image[] images = {
         			...
         			tool.getImage(getClass().getResource("Obstacles/Truck_1_Left.png")),
